...
Ucz się Python-a z Reeborg!
===========================


Nauka Python-a jest łatwa z Reeborg. Wszystko czego potrzebujesz to przeczytać
tutorial i uruchomić przykłady w `Świecie Reeborg-a <http://reeborg.ca/world.html>`_.
Wygodniej będzie jak tutorial i Świat Reeborg-a będą otwarte w oddzielnych oknach
lub zakładkach przeglądarki.
...
.. toctree::
   ...
   G. Przewodnik po swiecie Reeborg-a <reference/index>
